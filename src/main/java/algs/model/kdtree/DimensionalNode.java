...
public class DimensionalNode {
	 ...
	 * @param results   non-null ArrayList<IMultiPoint> into which located points are inserted.
	 ...
	 * its algs constructed the KDTree from the bottom up. It is marked as package private to
