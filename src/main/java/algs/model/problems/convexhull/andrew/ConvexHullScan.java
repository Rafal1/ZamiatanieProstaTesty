...
/**
 * Computes Convex Hull following Andrew's Algorithm. This algs is described
 * in the text.
 * 
...
public class ConvexHullScan implements IConvexHull {
	...
	/**
	 * Use Andrew's algs to return the computed convex hull for
	 ...
	 * <p>
	 * This algs will still work if duplicate points are found in
	 * the input set of points.
	 *
