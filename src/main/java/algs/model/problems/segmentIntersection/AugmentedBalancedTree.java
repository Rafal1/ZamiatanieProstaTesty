...
/**
 * The Balanced Binary Tree for this algs required internal nodes
...
public class AugmentedBalancedTree<K> extends BalancedTree<K,K> {
     ...
     * the leaves do. Thus we completely override insert.
     */
    ...
    protected void deleteEntry(BalancedBinaryNode<K,K> p) {
		...
		// invariant.  See CLR algs. No need to modify min/max, since already
