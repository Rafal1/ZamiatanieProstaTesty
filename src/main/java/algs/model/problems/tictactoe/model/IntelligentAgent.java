 ...
 * provided algs to select a move.
 * <p>
 * Since it relies on using a search algs to locate best move given what
...
public class IntelligentAgent extends Player {
	 ...
	 * 
	 * @return    a randomly selected best move to make, or null if game is already won or drawn.
	 */
