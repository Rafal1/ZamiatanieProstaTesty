 ...
 * 
 * @param <E>    type parameter to describe Edge Structure used by each algs
 *               variation.
 *                
...
public abstract class FlowNetwork<E> {
	...
	/**
	 * When algs completes, the final (failed) pass properly labels those
	...
	/**
	 * After the termination of the network flow algs, this method returns the final flow
