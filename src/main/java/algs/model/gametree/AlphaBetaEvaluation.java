 ...
 * <p>
 * Base this implementation on the Negmax algs, since the pruning code is
 ...
 * algs. Their overhead is minimal.
 * <p>
...
public class AlphaBetaEvaluation implements IEvaluation {
	...
	/**
	 * Given the board state, use alphaBeta algs to locate best move
	 * for original player. 
	 * <p>
